import { B as Block, S as Static, o as IconButtonWrapper, F as FullscreenButton, W as BlockTitle, n as Empty, ar as LineChart, al as globals } from './2-DWmO7qBD.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  async function load_chart() {
    ...
    if (!vegaEmbed) {
      vegaEmbed = (await import('./vega-embed.module-CML-QyNY.js')).default;
    }
    vegaEmbed(chart_element, spec, { actions: false }).then(function(result) {
      view = result.view;
      resizeObserver.observe(chart_element);
...
//# sourceMappingURL=Index28-CMCMCLgb.js.map
