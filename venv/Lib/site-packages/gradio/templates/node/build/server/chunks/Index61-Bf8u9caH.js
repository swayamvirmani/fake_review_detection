...
import { B as Block, S as Static, H as MarkdownCode, N as Check, K as Copy, F as FullscreenButton, Z as Checkbox } from './2-DWmO7qBD.js';
...
import { U as Upload } from './ModifyUpload-DY43qTWD.js';
import Index$1 from './Index27-DpHtYL5N.js';
...
const Table = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    ].join(" ").trim()}" style="${"height:" + escape(table_height, true) + "px;"}" role="grid" tabindex="0"${add_attribute("this", parent, 0)}><table class="svelte-1vwr9xf"${add_attribute("this", table, 0)}>${label && label.length !== 0 ? `<caption class="sr-only svelte-1vwr9xf">${escape(label)}</caption>` : ``} <thead class="svelte-1vwr9xf"><tr class="svelte-1vwr9xf">${show_row_numbers ? `${validate_component(RowNumber, "RowNumber").$$render($$result, { is_header: true }, {}, {})}` : ``} ${each(_headers, ({ value, id }, i) => {
...
//# sourceMappingURL=Index61-Bf8u9caH.js.map
