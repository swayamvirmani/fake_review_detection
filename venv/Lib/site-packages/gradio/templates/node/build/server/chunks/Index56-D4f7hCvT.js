...
import { B as Block, S as Static, j as BlockLabel, J as File$1, n as Empty, U as UploadText, o as IconButtonWrapper, q as IconButton, P as Undo, u as Download } from './2-DWmO7qBD.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-DY43qTWD.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-oURHBWQT.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-nldme8rS.js');
  return module.default;
}
...
//# sourceMappingURL=Index56-D4f7hCvT.js.map
