...
import { B as Block, S as Static, j as BlockLabel, X as Code$2, n as Empty, q as IconButton, K as Copy$1, D as DownloadLink, u as Download$1, o as IconButtonWrapper, Y as getWorkerProxyContext } from './2-DWmO7qBD.js';
...
const lang_map = {
  python: () => import('./index33-BOYhHBwj.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index34-GLr38nP3.js'),
      import('./frontmatter-uXBvqqJQ.js')
    ]);
  ...
  json: () => import('./index38-tfJ24W_U.js').then((m) => m.json()),
  html: () => import('./index35-B4IXnnk6.js').then((m) => m.html()),
  css: () => import('./index36-C0y6j-Ch.js').then((m) => m.css()),
  javascript: () => import('./index37-Uzevq-Et.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index37-Uzevq-Et.js').then(
...
//# sourceMappingURL=Index16-Dsc86r9J.js.map
